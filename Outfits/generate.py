...
credentials = service_account.Credentials.from_service_account_file(r'C:\Users\funmilayo.omisande\Downloads\primeval-creek-394208-a341c6fa1e8f.json')
...
def update_product_labels(
    ...
    update_mask = google.protobuf.field_mask_pb2.FieldMask(paths=['product_labels'])
